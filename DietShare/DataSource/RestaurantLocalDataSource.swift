...
class RestaurantsLocalDataSource: RestaurantsDataSource {
    ...
    private func prepopulate() {
        ...
        var restaurants = [
            ...
            Restaurant("18", "iSTEAKS Diner (Holland Village)", "17 Lor Liput, Singapore 277731", CLLocation(latitude: 1.3104967, longitude: 113.79518489999998), "64633165", StringList(.RestaurantType, ["American"]), "Loving the tenderness and juiciness of the steak. There's many side choices", "restaurant-14", testRatingList, StringList(.Post), 4.5),
