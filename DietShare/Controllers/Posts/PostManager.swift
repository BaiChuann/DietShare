...
//        let newPost22 = Post(userId: "3", caption: "I will NEVER try this! My dad cooked a whole pot of paste!!! He REALLY need to learn how to cook. I think it tastes like chicken", time: dateFormatterGet.date(from: "2017-12-03 13:14:15")!, photo: UIImage(named: "topic7-3")!, restaurant: nil, topics: ["3", "6", "7"])
